...
```
Las magnitudes más frecuentes son las que poseen menor energia liberada con 5.5 y las menos frecuentes con la energia liberada con magnitudes mayores como 7.9
...
Los datos se ven bastante asimétricos en todas las categorías ya que los percentiles están repartidos asimetricamente respecto a la mediana, no obstante, no son poco dispersos respecto a la media aritmética de magnitud, a pesar de que el evento tipo Earthquake presenta bastantes valores atipicos.  

Adicional, la categoría más frecuente por tipo de de evento y con mayor magnitud de liberacion de energía es el tipo explosión. 
